        ...
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                <a href="managerdashboard.php" class="nav-item nav-link">
                    ...
                    <a href="managerbookings.php" class="nav-item nav-link active">
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            ...
            <div class="bg-light rounded p-4 mb-4">
                <form action="managerbookings.php" method="GET" class="row g-3 align-items-center">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3 d-flex">
                        ...
                        <a href="managerbookings.php" class="btn btn-secondary flex-grow-1">Clear</a>
                    </div>
                </form>
            </div>
            ...
            async function handleBookingAction(action, id) {
                ...
                if (action === 'approve' || action === 'cancel') {
                    ...
                    try {
                        ...
                        const response = await fetch('managerbookings.php', {
                            method: 'POST',
                            body: formData
                        });
