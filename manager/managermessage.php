    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="managermessage.php" class="nav-item nav-link active" id="navMessageLink">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded p-4 d-flex flex-column flex-md-row" style="min-height:480px;">
                ...
                <div class="user-list-sidebar px-3 py-2 mb-3 mb-md-0 flex-shrink-0" style="max-width:260px;min-width:220px;">
                    ...
                    <div id="userListMsg">
                        <?php
                        // Loop through the active users and do not include admins in the chat users list.
                        foreach ($users as $user):
                            if ($user['id'] == $userId || strtolower($user['user_type']) === 'admin') continue;
