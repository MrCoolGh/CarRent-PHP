...
function getCustomerBookingsWithDetails($userId) {
    ...
    $query = "
        SELECT 
            ...
            b.booking_status, b.booking_date, b.pickup_date, b.pickup_time, b.dropoff_date, b.dropoff_time,
            b.pickup_location, b.customer_note, b.admin_message, b.total_days, b.total_amount
        FROM bookings b
...
<div class="container-fluid position-relative bg-white d-flex p-0">
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="adminmybookings.php" class="nav-item nav-link active">
    ...
    <div class="content">
            ...
            <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img class="rounded-circle me-lg-2" src="<?php echo $userProfileImage; ?>" alt="" style="width: 40px; height: 40px;">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row g-4" id="customerBookingsRow">
                ...
                <?php else: ?>
                    <?php foreach ($customerBookings as $index => $booking):
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4 booking-card" id="customerBookingCard<?php echo $cardId; ?>">
                            <div class="h-100 bg-light rounded p-4">
                                ...
                                <!-- Main Car Image, Thumbnails, & Title -->
                                <div class="text-center mb-3">
                                    <img src="<?php echo htmlspecialchars($carImage); ?>" alt="<?php echo htmlspecialchars($booking['car_name']); ?>" class="rounded mb-2 main-car-img" style="width:100%; height:200px; object-fit:cover; max-width:320px;">
                                    <!-- Small Images Thumbnails -->
                                    <div class="d-flex justify-content-center gap-2 mt-2">
                                        <img src="<?php echo htmlspecialchars($carImage); ?>" alt="Thumbnail 1" class="rounded img-thumbnail" style="width:65px; height:45px; object-fit:cover; cursor:pointer;">
                                        <img src="<?php echo htmlspecialchars($carImage); ?>" alt="Thumbnail 2" class="rounded img-thumbnail" style="width:65px; height:45px; object-fit:cover; cursor:pointer;">
                                        <img src="<?php echo htmlspecialchars($carImage); ?>" alt="Thumbnail 3" class="rounded img-thumbnail" style="width:65px; height:45px; object-fit:cover; cursor:pointer;">
                                    </div>
                                    <!-- Car Title below thumbnails -->
                                    <div class="text-center mt-2">
                                        <h5 class="fw-bold"><i class="fa fa-car me-1"></i><?php echo htmlspecialchars($booking['car_name']); ?></h5>
                                    </div>
                                </div>
                                <!-- Car Details -->
                    ...
                    <?php endforeach; ?>
                <?php endif; ?>
                <!-- Add more cards as needed, incrementing IDs for each -->
            </div>
        </div>
        ...
        <script>
            ...
            // Enhanced booking data with database integration
            let carPerDayPrice = {}; // Will be populated dynamically
            let deleteBookingId = null;

            // Calculate initial card totals on page load
            ...
            // Enhanced show Edit Modal with database data
            function showEditBookingModal(id) {
                try {
                    ...
                    // Get price per day from the button's data attribute
            ...
            // Format "YYYY-MM-DDTHH:MM" to "YYYY-MM-DD HH:MM"
            ...
            // Calculate and display number of days and total price
            ...
            // Enhanced save edited booking with database integration
