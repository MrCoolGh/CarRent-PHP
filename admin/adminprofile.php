    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="adminprofile.php" class="nav-item nav-link active"><i class="fa fa-user-circle me-2"></i>Profile</a>
            </div>
        </nav>
    </div>
    <!-- Sidebar End -->
    ...
    <div class="content">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-5 mb-4">
                    <div class="bg-light rounded p-4 h-100">
                        <h4 class="mb-4 text-center text-primary"><i class="fa fa-user-edit me-2"></i>Edit Profile</h4>
                ...
                <div class="col-12 col-md-7">
                    <div class="bg-light rounded p-4 mb-4">
                        <h5 class="mb-4 text-primary"><i class="fa fa-lock me-2"></i>Change Password</h5>
                        <form id="passwordChangeForm" onsubmit="changePassword(); return false;">
                            ...
                            <button type="submit" class="btn btn-primary w-100 mb-2"><i class="fa fa-key me-2"></i>Change Password</button>
                    ...
                    <div class="bg-light rounded p-4 mt-4">
                        <h5 class="mb-3 text-danger"><i class="fa fa-trash me-2"></i>Delete Account</h5>
                        <p class="mb-2 small">Type <b>DELETE</b> below to confirm. This action cannot be undone.</p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-0 pb-0">
                        <h5 class="modal-title" id="deleteConfirmModalAccountLabel"><i class="fa fa-exclamation-triangle text-warning me-2"></i>Confirm Account Deletion</h5>
        ...
        <script>
            ...
            async function saveProfileEdit() {
                ...
                try {
                    const response = await fetch('adminprofile.php', {
                        method: 'POST',
                        body: formData
                    });
            ...
            async function deleteProfile() {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        setTimeout(() => { window.location.href = '../public/signup.php'; }, 2000);
                    } else {
